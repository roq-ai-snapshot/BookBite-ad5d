  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Elevate Your Dining Experience with BookBite: The Ultimate SaaS Application for Streamlining Restaurant Management and Enhancing Customer Satisfaction"
        />
      </Head>
        ...
        <Flex p={8} flex={1} align={'center'} justify={'center'}>
          <Stack spacing={6} w={'full'} maxW={'lg'}>
            ...
            <Text fontSize={{ base: 'md', lg: 'lg' }} color={'gray.500'}>
              Elevate Your Dining Experience with BookBite: The Ultimate SaaS Application for Streamlining Restaurant
